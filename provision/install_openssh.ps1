...
$path = ";$($env:SystemDrive)\Program Files(x86)\OpenSSH"
if ([System.Environment]::Is64BitOperatingSystem) { $path += ";$($env:SystemDrive)\Program Files\OpenSSH" }
[System.Environment]::SetEnvironmentVariable("path", $($env_path.Insert($env_path.Length, ";$($env:SystemDrive)\Program Files\OpenSSH;%systemdrive%\Program Files(x86)\OpenSSH")), "Machine")
